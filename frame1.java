...
public class frame1 extends JFrame {
	...
	public static void main(String[] args) {
		...
		String[] list;
		try {
			fs = new File("C:\\Users\\thotl\\eclipse-workspace\\javaproject\\Sentimental_Analysis\\src\\Data.txt");
	...
	public frame1() {
		...
		label1.setBounds(138, 59, 86, 38);
		contentPane.add(label1);
		JLabel label2 = new JLabel("Analysis : Partially positive ( -4.0 )");
